...
@section('title', 'Add Disease Table')
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header pb-0">
                                <h5>Delete Disease</h5>
                            </div>
                            <div class="card-body">
                                <form class="form theme-form" action="{{route('disease.destroy',['disease' => $id])}}" method="POST" enctype="multipart/form-data">
                                    @method('delete')
                                    @csrf
                                    <div class='mb-3 row'>
                                    ...
                                    <div class="card-footer">
                                        <div class="col-sm-9 offset-sm-3">
                                            ...
                                            <a class="btn btn-primary" href="{{route('disease.index')}}">Cancel</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
