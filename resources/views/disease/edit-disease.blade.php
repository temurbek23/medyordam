...
@section('title', 'Edit Disease Table')
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="form theme-form" action="{{route('disease.update', ['disease' => $model->id])}}" method="POST" enctype="multipart/form-data">
                                    @method('put')
                                    @csrf
                                    <div class='mb-3 row'>
                                    ...
                                    <div class="card-footer">
                                        <div class="col-sm-9 offset-sm-3">
                                            ...
                                            <a class="btn btn-secondary" href="{{route('disease.index')}}">Cancel</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
